...
from inference.MMstream_inference import stream_inference
...
if __name__ == '__main__':
    ...
    if opt.task == 'normal':
        ...
        if opt.rgb_model is not '':
            raise NotImplementedError('Currently the streaming mode only supports micro-motion (mm) models. One can easily adapt the code for rgb model.')
